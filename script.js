...
(function () {
  ...
  function bindHomePageEvents() {
    ...
    // Premium focus-glow on the learning card (class fallback for browsers without :has())
    const homeLearningCard = learningInput.closest('.learning-card');
    if (homeLearningCard) {
      learningInput.addEventListener('focus', () => homeLearningCard.classList.add('is-focused'));
      learningInput.addEventListener('blur', () => homeLearningCard.classList.remove('is-focused'));
    }
  ...
  function bindTeacherPageEvents() {
    ...
    // Premium focus-glow on the teacher card (class fallback for browsers without :has())
    const teacherLearningCard = teacherInput.closest('.learning-card');
    if (teacherLearningCard) {
      teacherInput.addEventListener('focus', () => teacherLearningCard.classList.add('is-focused'));
      teacherInput.addEventListener('blur', () => teacherLearningCard.classList.remove('is-focused'));
    }
